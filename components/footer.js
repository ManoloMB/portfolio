        ...
        <footer className="border-t-2 border-t-white/5 py-10 items-center">
            ...
            <section className="flex sm:flex-row-reverse flex-col sm:gap-10 gap-5">
                ...
                <article id='contacto' className="flex flex-col flex-shrink-0 items-center justify-center sm:items-start">
                    ...
                    <a href='https://github.com/ManoloMB' target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-4 hover:scale-105 hover:text-cyan-500 transition-all duration-300">
                    ...
                    <a href='https://www.linkedin.com/in/manuel-martinez-bernal/' target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-4 hover:scale-105 hover:text-cyan-500 transition-all duration-300">
